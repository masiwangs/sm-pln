<template>
  <v-row>
    ...
    <v-col cols="12">
      <basket-card tahap="kontrak" :basket="1" @show_material="showMaterial" @show_jasa="showJasa" @new_project="newProject"/>
    </v-col>
    <v-col cols="12">
      <basket-card tahap="kontrak" :basket="2" @show_material="showMaterial" @show_jasa="showJasa" @new_project="newProject"/>
    </v-col>
    <v-col cols="12">
      <basket-card tahap="kontrak" :basket="3" @show_material="showMaterial" @show_jasa="showJasa" @new_project="newProject"/>
    </v-col>
    ...
    <!-- <kontrak-form ref="formSkki" :is_show="new_project.is_show" :basket="new_project.basket" @hide_dialog="new_project.is_show = false"/> -->
  </v-row>
</template>
...
<script>
  ...
  import KontrakForm from '~/components/dialog/KontrakForm.vue'

  export default {
    components: {BasketCard, MaterialList, JasaList, KontrakForm},
    data() {
      return {
        breadcrumbItems: [{
            text: 'Dashboard',
