<template>
  <v-row>
    ...
    <v-col cols="12">
      <basket-card tahap="pelaksanaan" :basket="1" @show_material="showMaterial" @show_jasa="showJasa" @new_project="newProject"/>
    </v-col>
    <v-col cols="12">
      <basket-card tahap="pelaksanaan" :basket="2" @show_material="showMaterial" @show_jasa="showJasa" @new_project="newProject"/>
    </v-col>
    <v-col cols="12">
      <basket-card tahap="pelaksanaan" :basket="3" @show_material="showMaterial" @show_jasa="showJasa" @new_project="newProject"/>
    </v-col>
    ...
    <pelaksanaan-form ref="formSkki" :is_show="new_project.is_show" :basket="new_project.basket" @hide_dialog="new_project.is_show = false"/>
  </v-row>
</template>
...
<script>
  ...
  import PelaksanaanForm from '~/components/dialog/PelaksanaanForm.vue'

  export default {
    components: {BasketCard, MaterialList, JasaList, PelaksanaanForm},
    data() {
      return {
        breadcrumbItems: [{
            text: 'Dashboard',
