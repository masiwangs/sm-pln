<template>
  <v-row>
    ...
    <v-col cols="12">
        <v-card elevation="0" class="rounded-lg">
            <v-card-title class="d-flex justify-space-between">
                <div>Basket 1</div>
                <v-btn elevation="0" class="rounded-lg" v-on:click="newProject(basket)" color="primary"><v-icon class="mr-2">mdi-plus-box</v-icon> Baru</v-btn>
            </v-card-title>
    ...
    <v-col cols="12">
      <basket-card tahap="prk" :basket="2" @show_material="showMaterial" @show_jasa="showJasa" @new_project="newProject"/>
    </v-col>
    <v-col cols="12">
      <basket-card tahap="prk" :basket="3" @show_material="showMaterial" @show_jasa="showJasa" @new_project="newProject"/>
    </v-col>
