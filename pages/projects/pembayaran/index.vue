...
<script>
import PembayaranTable from '~/components/table/PembayaranTable.vue';
            ...
            this.$axios.get('/pembayarans')
                .then(res => {
                    res.data.data.forEach(el => {
                        ...
                        el.jasa_transactions.forEach(el => {
                            sum_jasa += el.harga;
                        })

                        el.material_transactions.forEach(el => {
                            sum_material += el.harga * el.jumlah;
                        })

                        el.pembayarans.forEach(el => {
                            terbayarkan += el.nilai;
                        })

                        el.tagihan = sum_jasa + sum_material;
                        el.terbayarkan = terbayarkan;
                    })
